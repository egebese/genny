...
/**
 * Where the credits went. A ledger is only trustworthy if the person paying can
 * read it, so this is the whole thing, not a summary of it.
 */
export default async function UsagePage() {
  ...
  const [balance, report] = await Promise.all([creditBalance(actorId), usageReport(actorId)])
